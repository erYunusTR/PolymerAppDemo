      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-drawer id="drawer" slot="drawer" swipe-open="[[narrow]]">
          ...
          <iron-selector selected="[[page]]" attr-for-selected="name" class="drawer-list" role="navigation">
            <a name="view1" href="[[rootPath]]view1">App Elements</a>
            <a name="view2" href="[[rootPath]]view2">Iron Element</a>
            <a name="view3" href="[[rootPath]]view3">Paper Elements</a>
            <a name="view4" href="[[rootPath]]view4">Gold Elements</a>
            <a name="view5" href="[[rootPath]]view5">Platinum Elements</a>
            <a name="view6" href="[[rootPath]]view6">Data Elements</a>
            <a name="view7" href="[[rootPath]]view7">Layout Element</a>
            <a name="view8" href="[[rootPath]]view8">Neon Element</a>
          </iron-selector>
        </app-drawer>
        ...
        <app-header-layout has-scrolling-region="">
          ...
          <app-header slot="header" condenses="" reveals="" effects="waterfall">
            <app-toolbar>
              ...
              <div main-title="">Polymer Elements</div>
            </app-toolbar>
          </app-header>
